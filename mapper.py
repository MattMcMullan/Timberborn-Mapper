...
def add_manual_image_to_timberborn_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument('--treeline-cutoff', type=float, help='Relative pixel intensity under which trees will not spawn.', default=0.1)
    parser.add_argument('--birch-cutoff', type=float, help='Relative pixel intensity under which trees will spwan as birch trees.', default=0.4)
    parser.add_argument('--pine-cutoff', type=float, help='Relative pixel intensity under which trees will spwan as pine trees.', default=0.7)
